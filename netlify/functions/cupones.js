exports.handler = async function(event, context) {
  ...
  try {
    ...
    while ((match = offerRegex.exec(xml)) !== null) {
      ...
      coupons.push({id: get("OfferCode"), name: get("OfferDescription"), value: get("OfferValue"), brand: get("Brand"), brandIcon: get("BrandIconUrl"), image: get("CouponImage"), purchase: get("PurchaseDescription"), category: get("Category"), expires: get("SiteExpiryOn")});
    }
